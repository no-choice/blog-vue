    ...
    <el-row>
      <el-col :span="12" :offset="8">
        <div class="search-bar">
          ...
          <el-button type="primary" style="float: right;" @click="AddBlog">发布博客</el-button>
        </div>
      </el-col>
    </el-row>
...
<script>
import BlogList from '../components/MyBlogList.vue';
...
.blog-list-container {
  ...
  /* Optional: adjust height based on your layout */
}
</style>
